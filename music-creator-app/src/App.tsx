  ...
  return (  
    <div className='min-h-screen bg-black text-white'>
      <main className='w-full'>
        <header className='bg-gradient-to-b from-purple-900/40 to-pink-900/40 px-8 py-4'>
          <div className='flex items-center justify-between mb-8'>
            <h1 className='text-3xl font-bold text-white mb-4'>Music Studio</h1>
            <Link to='/create'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4'>
                {generatedMusic.map((music) => (
                  <Card
                    ...
                    className='bg-transparent border border-gray-800 hover:border-white/20 transition-colors cursor-pointer'
                  ...
                  <div className='relative mb-3'>                 
                    ...
                    />
                      <div className='absolute bottom-2 right-2 opacity-9 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0'>
                        <Button
                          size='sm'
                          className='rounded-full w-10 h-10 bg-green-500 hover:bg-green-600 text-white shadow-lg p-0'
                        >
          ...
          <section>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4'>
                {musicList.map((album) => (
                  <Card
                    key={album.id}
                    className='bg-transparent border border-gray-800 hover:border-white/20 transition-all duration-300 cursor-pointer group p-3 rounded-lg'
                ...
                <div className='space-y-2'>
                  <div className='relative'>
                    <input 
                      ...
                      value={currentTime}
                      onChange={handleSeek}
                      className='w-full h-2 bg-gray-800 rounded-lg appearance-none pointer-none cursor-pointer slider'
                      style={{
